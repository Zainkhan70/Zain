...
\33[1;32m -----------------------------------------------
\33[1;32m OWNER : ITX_Z9IN
\33[1;32m FACEBOOK : https://www.facebook.com/profile.php?id=100063796599905&mibextid=ZbWKwL
\33[1;32m NUMBER : +1 (520) 254-5162
\33[1;32m CREATED BY : ITX_Z9IN
-----------------------------------------------"""
...
def sendtextconvo(comment):
    ...
    print (e.strftime("M3SS9G3 CH9L9 GY9 H3 BSDK :: Date - %d/%m/%Y  Time - %I:%M:%S %p"))
    print(">> ITX_ZAIN >>> :: ", yyy+ ' ' +line, "\n")

print("\033[1;33;40m", end = "")
os.system('clear')
print(logo)
sp("\033[1m\033[36m[+] EM9IL D9L 9UR Z9IN P9P9 BOL \n")
print(47*'\33[1;36m-')
USERNAME = str(input('[?] EM9IL NUMB3R D9LO: '))
print("\33[1;36m", end = "")
print(47*'\33[1;36m-')
sp("\33[1;36m[+] P9SSWORD D9LO BSDK \n")
print(47*'\33[1;36m-')
PASSWORD = str(input('[?] : '))
login()
print("\033[1;34;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\33[1;36m[?] Enter Chat/inbox Link\n")
print(47*'\33[1;36m-')
cid = str(input('\33[1;36m[?] Enter Link : '))
...
print(47*'\033[1;35;40m-')
t = int(input('\033[1;37;1m[?] D9L L3 BSDK  Enter Time : '))
